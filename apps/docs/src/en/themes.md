...
Every theme shares the same shadcn/ui-style structure. Each one only sets the [variable contract](/en/tokens): colors, radii, depth and fonts. Switch the mode to compare, or apply a theme to the whole site.
...
The contract, the derivations and the density, radius and contrast dials are covered in the [theming](/en/guide/theming) guide.
