...
- Built-in strings (accessible names, placeholders, empty states, date names) default to English (Portuguese and Spanish included); switch with `app.use(createMsI18n({ locale: "pt-BR" }))` or `<MsProvider locale="pt-BR" :messages="{…}">` ([guide](https://github.com/magicmidia/magicstyle/blob/main/docs/i18n.md)).
